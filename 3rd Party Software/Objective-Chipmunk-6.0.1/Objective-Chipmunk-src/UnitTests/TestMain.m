...
int main(void){
	[ChipmunkSpace class]; // force an early init
	NSAutoreleasePool *pool = [[NSAutoreleasePool alloc] init];
	
//	@try {
//		Class klass = [[NSBundle mainBundle] classNamed:@"CallbacksTest"];
//		NSObject *obj = [[klass alloc] init];
//		[obj performSelector:@selector(testSleepingSensorCallbacks)];
//		return 0;
//	} @catch (NSException *e){
//		PrintException(e);
//	} @finally {
